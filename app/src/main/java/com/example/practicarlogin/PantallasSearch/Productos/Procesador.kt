package com.example.practicarlogin.PantallasSearch.Productos
...
import com.example.practicarlogin.PantallasNavegaciones.content
...
fun listaCpu(cpu: List<CPU>?, viewModell: SearchViewModel) {
    ...
    val maxSelect by viewModell.maxSelect.observeAsState()

    val ordenar by viewModell.ordenado.observeAsState()
