...
@Composable
fun productos(component: Int, function: (String) -> Unit) {
    ...
    Column(
        ...
        val filtrarItems = remember(busqueda) {
            ...
            ListaPiezas.procesadores.filter { e -> e.nombre.contains(busqueda, ignoreCase = true) ||e.marca.contains(busqueda, ignoreCase = true) }
        }
                    ...
                    Column(modifier = Modifier.fillMaxSize()) {
                        Row(
                            ...
                            Column {
                                ...
                                Text("${e.precio}€", fontSize = 15.sp, fontFamily = Fuentes.mulishSemiBold, modifier = Modifier.align(Alignment.Start).padding(start = 1.dp))
                                Spacer(modifier = Modifier.padding(5.dp))
                                Row {
                                    OutlinedButton(
                                    ...
                                    Button(
                                        ...
                                        content = { Text(languageSelect.agregar, color = Color.White) }
                                    )
                                }
                            }
