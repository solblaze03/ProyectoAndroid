...
fun productos(
    ...
    if (component == 0) {
        ListaProcesador(function, viewModel, Volver)
    }else if(component == 1){
        MotherBoard(function,viewModel,Volver)
    }
...
@Composable
fun MotherBoard(function: (String) -> Unit, viewModel: ComponentViewModel, Volver: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
                            ...
                            Row(
                                ...
                                Column {
                                    ...
                                    Row {
                                        ...
                                        Spacer(modifier = Modifier.padding(4.dp))
                                        Button(
                                            onClick = { viewModel.guardarCPU(e);Volver() },
                                            modifier = Modifier
                                                .weight(1.5f)
                                                .height(38.dp),
                                            colors = ButtonDefaults.buttonColors(
