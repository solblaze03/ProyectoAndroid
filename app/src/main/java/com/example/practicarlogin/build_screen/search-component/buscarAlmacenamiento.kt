...
fun ListaAlmacenamiento(
    ...
    val listSSD by viewModel.ssdlist.observeAsState(emptyList())
                            ...
                            Row {
                                ...
                                Button(
                                    onClick = {
                                        ...
                                        viewModel.guardarAlmacenamiento(e); Volver();viewModel.cambiarComponente(
                                        2
                                    );viewModel.unlockGraphic()
                                    },
                                    modifier = Modifier
                                        .weight(1.5f)
                                        .height(38.dp),
